...
public class SistemaAeropuerto {
	private static final String PATCH = "C:/Users/Floor/eclipse-workspace/TPE-Programacion3/src/datasets/";
		 	...
		 	while(numero !=0) {
					try {
						...
						case 6:
							System.out.println("Ingrese nombre Aeropuerto Origen");
//							origen = entrada.readLine();
							System.out.println(grafo.recorridoGreedy("Jorge Newbery"));
							entrada.readLine();
							break;
						case 7:
							System.out.println("Ingrese nombre Aeropuerto Origen");
